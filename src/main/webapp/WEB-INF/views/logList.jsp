...
<script type="text/javascript">
	function linkPage(pageNo) {
		location.href = "./logList.do?pageNo="
				+ pageNo
						...
						<form action="./logList.do" method="get">
							<select name="searchName">
								...
								<option value="content"
									<c:if test="${searchName eq 'content' }">selected="selected</c:if>>내역</option>
								<option value="date"
									<c:if test="${searchName eq 'date' }">selected="selected</c:if>>날짜</option>
