...
<meta charset="UTF-8">
<title>'${detail.b_title}' 게시글 수정</title>
<style type="text/css">
#write {
	margin: 0 auto;
	height: 300px;
...
<body>
	...
	<div id="middle" align="center"
		...
		<div id="article"
			...
			<div id="write">
				<form action="./ubUpdate.do" id="fileForm"
					enctype="multipart/form-data" method="post">
					<input type="hidden" name="l_no" value="${detail.l_no }"> <input
						type="hidden" name="b_no" value="${detail.b_no }"> <select
						name="region">
					...
					</select> <input type="text" name="b_title" value="${detail.b_title }">
					<br>
					<textarea name="b_content" id="summernote">${detail.b_content }</textarea>
					<br>
					<script type="text/javascript">
